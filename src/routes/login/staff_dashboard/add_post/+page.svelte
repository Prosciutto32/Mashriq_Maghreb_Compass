<script lang="ts">
    ...
    async function handleSubmit(event: Event) {
        ...
        try {
            ...
            Formel?.reset();
            goto("/login/staff_dashboard/edit_post"); // Redirect to view posts after submission
        } catch (e) {
...
<p class="head">Please fill out the form below to add a post.</p>
<form  bind:this={Formel} onsubmit={handleSubmit}>
    ...
    <button type="button" onclick={() => Formel?.reset()}>Cancel</button>
</form>
