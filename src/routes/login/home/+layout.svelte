...
<div class="grid-container">
	<div class="user-column">
        <UserCard name={Saved_Name} photoURL={Saved_photoURL} link="/login/home" />
        
		<div class="actions">
			<a href="/login/home/make_a_request" aria-current={page.url.pathname === '/login/home/make_a_request' }>Make a request</a>
			<a href="/login/home/view_requests" aria-current={page.url.pathname === '/login/home/view_requests' }>View requests</a>
		</div>
